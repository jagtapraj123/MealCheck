...
if __name__ == "__main__":
    ...
    doc2vec = Doc2Vec(documents, vector_size=100, window=2, workers=64, epochs=1)

    doc2vec.save('../saved_models/doc2vec_model')

    print("Vectors: {}".format(doc2vec.dv.vectors.shape))
    
    k_means = KMeans(10000).fit(doc2vec.dv.vectors)
    
    clusters = k_means.labels_
    cluster_centers = k_means.cluster_centers_

    np.save('../saved_models/clusters.npy', clusters)
